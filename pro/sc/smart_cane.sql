...
CREATE TABLE `sensor_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `device_id`(`device_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '传感器数据表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sensor_data` VALUES (22, '1', 1, 1, 1, 1, 1, 1, '2026-04-11 16:00:00', '2026-04-11 16:00:00');
...
INSERT INTO `visually_impaired_user` VALUES (2, 'zhangweiming', '123456', '张维明', '13811223344', '110102198506154321', '北京市西城区西长安街12号', '2026-04-11 12:34:44', '2026-04-11 12:34:44');
